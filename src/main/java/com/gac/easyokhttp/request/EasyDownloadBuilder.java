...
import com.gac.easyokhttp.body.ResponseProgressBody;
import com.gac.easyokhttp.callback.EasyDownloadCallback;
import com.gac.easyokhttp.response.DownloadResponseHandler;
...
public class EasyDownloadBuilder {
    ...
    public EasyDownloadBuilder setCompleteBytes(@NonNull Long completeBytes) {
        if(completeBytes > 0L) {
